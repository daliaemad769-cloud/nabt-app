  ...
  return (
    <main className="min-h-screen bg-[#FCFBF8] text-right p-4 md:p-8 font-sans flex flex-col" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between items-center mb-10">
        <Link href="/herbs" className="text-[#7D5592] hover:text-[#1E4D2B] font-medium transition-colors inline-flex items-center gap-2 text-sm order-2 md:order-1 mt-4 md:mt-0">
          &rarr; العودة للأعشاب
        </Link>
        <div className="text-center order-1 md:order-2">
          <h1 className="text-3xl font-bold text-[#1E4D2B] font-serif">تفاصيل المنتج</h1>
          <p className="text-[#7D5592] text-sm mt-1">مزيج طبيعي فاخر لصحة أفضل</p>
        </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="mb-6 border-b border-[#E8EDE6] pb-6 relative z-20">
              ...
              <p className="text-gray-600 text-sm md:text-lg leading-relaxed mt-2">
                أزهار لافندر نقية 100% مقطوفة بعناية من أراضي سيناء للحفاظ على الزيوت الطيارة وخصائصها المهدئة.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 relative z-20">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-white shadow-sm border border-[#E8EDE6] flex items-center justify-center flex-shrink-0 text-[#7D5592]">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">معالجة بأعلى المعايير.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">لا يحتوي على ألوان صناعية.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#1E4D2B] text-base">مناسب للجميع</h3>
                  <p className="text-gray-500 text-sm mt-1">مثالي للاستخدام اليومي.</p>
                </div>
              </div>
            </div>

            <button className="w-full md:w-2/3 bg-[#7D5592] text-white py-4 rounded-2xl font-bold text-lg hover:bg-[#603f72] transition-all shadow-lg hover:shadow-xl relative z-20">
              إضافة إلى السلة
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-4 relative z-20">
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#1E4D2B] mb-6 flex items-center gap-2">
              <span className="text-[#7D5592]">✨</span> الفوائد الصحية
            </h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 flex flex-col items-center text-center hover:-translate-y-1 transition-transform duration-300">
                <span className="text-[#7D5592] text-2xl mb-2 bg-[#FCFBF8] w-12 h-12 flex items-center justify-center rounded-full">🛡️</span>
                <h4 className="font-bold text-[#1E4D2B] text-sm mb-1">يدعم المناعة</h4>
                <p className="text-gray-500 text-xs">يقوي جهاز المناعة.</p>
              </div>
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 flex flex-col items-center text-center hover:-translate-y-1 transition-transform duration-300">
                <span className="text-[#7D5592] text-2xl mb-2 bg-[#FCFBF8] w-12 h-12 flex items-center justify-center rounded-full">🧘‍♀️</span>
                <h4 className="font-bold text-[#1E4D2B] text-sm mb-1">يقلل التوتر</h4>
                <p className="text-gray-500 text-xs">يساعد على الاسترخاء.</p>
              </div>
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 flex flex-col items-center text-center hover:-translate-y-1 transition-transform duration-300">
                <span className="text-[#7D5592] text-2xl mb-2 bg-[#FCFBF8] w-12 h-12 flex items-center justify-center rounded-full">⚡</span>
                <h4 className="font-bold text-[#1E4D2B] text-sm mb-1">يعزز الطاقة</h4>
                <p className="text-gray-500 text-xs">يمنحك نشاطاً وحيوية.</p>
              </div>
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 flex flex-col items-center text-center hover:-translate-y-1 transition-transform duration-300">
                <span className="text-[#7D5592] text-2xl mb-2 bg-[#FCFBF8] w-12 h-12 flex items-center justify-center rounded-full">✨</span>
                <h4 className="font-bold text-[#1E4D2B] text-sm mb-1">يحسن البشرة</h4>
                <p className="text-gray-500 text-xs">يساهم في نضارة البشرة.</p>
              </div>
              <div className="col-span-2 bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 flex flex-row items-center gap-4 text-right hover:-translate-y-1 transition-transform duration-300">
                 <span className="text-[#7D5592] text-2xl bg-[#FCFBF8] w-12 h-12 flex items-center justify-center rounded-full flex-shrink-0">🍃</span>
                 <div>
                     <h4 className="font-bold text-[#1E4D2B] text-sm mb-1">يحسن الهضم</h4>
                     <p className="text-gray-500 text-xs">يساعد على تهدئة الأمعاء وتحسين عملية الهضم بشكل مريح.</p>
                 </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#1E4D2B] mb-6 flex items-center gap-2">
              <span className="text-[#7D5592]">☕</span> طريقة التحضير
            </h3>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 relative pt-6 hover:-translate-y-1 transition-transform duration-300">
                <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-[#7D5592] text-white flex items-center justify-center text-sm font-bold border-4 border-[#FCFBF8]">1</span>
                <p className="text-gray-700 text-sm font-medium leading-relaxed">ضع ملعقة صغيرة (2-3 جرام) من المزيج في كوب.</p>
              </div>
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 relative pt-6 hover:-translate-y-1 transition-transform duration-300">
                <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-[#7D5592] text-white flex items-center justify-center text-sm font-bold border-4 border-[#FCFBF8]">2</span>
                <p className="text-gray-700 text-sm font-medium leading-relaxed">أضف ماء ساخن (90-95 درجة مئوية) للكوب.</p>
              </div>
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 relative pt-6 hover:-translate-y-1 transition-transform duration-300">
                <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-[#7D5592] text-white flex items-center justify-center text-sm font-bold border-4 border-[#FCFBF8]">3</span>
                <p className="text-gray-700 text-sm font-medium leading-relaxed">اتركه مغطى لينقع لمدة 5-7 دقائق.</p>
              </div>
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#E8EDE6]/50 relative pt-6 hover:-translate-y-1 transition-transform duration-300">
                <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-[#7D5592] text-white flex items-center justify-center text-sm font-bold border-4 border-[#FCFBF8]">4</span>
                <p className="text-gray-700 text-sm font-medium leading-relaxed">حركه برفق واستمتع بمشروبك الصحي.</p>
              </div>
            </div>
            
            <div className="bg-[#7D5592]/5 p-4 rounded-2xl border border-[#7D5592]/10 flex items-start gap-3">
              <span className="text-xl">💡</span>
              <p className="text-sm text-[#1E4D2B] font-medium leading-relaxed">
                <strong>نصيحة ذهبية:</strong> يمكن تناوله 1-2 مرة يومياً بانتظام للحصول على أفضل النتائج والنوم الهادئ.
              </p>
            </div>
          </div>
